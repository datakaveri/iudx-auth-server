...
GRANT SELECT,INSERT,UPDATE ON TABLE consent.resourcegroup TO auth;
GRANT SELECT,INSERT,UPDATE ON TABLE consent.access	 TO auth;
GRANT SELECT,INSERT,UPDATE ON TABLE consent.capability	 TO auth;
